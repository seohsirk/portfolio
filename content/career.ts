...
export const career: Job[] = [
  {
    ...
    points: [
      ...
      "Wordly AI. 검색·글 생성·이미지 제작을 잇는 LangGraph Agent 콘텐츠 제작 서비스. v2 「블로그 팩토리」로 병렬 대량생성하며 에이전시 B2B 로 전환",
  ...
  },
  {
    ...
    points: [
      ...
      "KidSafe. 전체 트래픽을 중계하는 MITM 대신 패킷의 Destination 만 복사해 별도 서버가 판별합니다. 본망 성능에 영향을 주지 않고 유해 콘텐츠를 차단합니다. Celcom 출시 · XL 현지화 · 기숙학교용 확장",
